...
" 状态栏设置
set ruler                              " 显示光标位置
set rulerformat=%15(%c%V\ %p%%%)       " 自定义状态栏格式
...
set completeopt=longest,menu           " 补全菜单选项
...
nnoremap <slient> U :redo<CR>
nnoremap <slient> J 5j
nnoremap <slient> K 5k
nnoremap <slient> <C-tab> :tabnext<CR>
nnoremap <slient> <leader>fe :e $MYVIMRC<CR>
nnoremap <slient> <leader>ww <C-w>w
